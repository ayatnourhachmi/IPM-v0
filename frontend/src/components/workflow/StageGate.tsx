...
export default function StageGate({ label, isActive, isCompleted, color, delay = 0, onClick, isMuted = false }: StageGateProps) {
    const c = isMuted && !isActive && !isCompleted ? mutedColor : colorClasses[color];
